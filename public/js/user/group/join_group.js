$('a.join-group').click(function() {
	...
	var foreigner = null;
	var group = {'id':id};
	var form = 'join-group-form';
	$.post('/user/opegroup', {'op':'foreigner', 'data':group, '_token': kw_csrf}, function(data) {
		var li = [];
		for (var i in data) {
